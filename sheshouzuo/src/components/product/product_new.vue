...
<template>
  ...
  <Row type="flex">
    ...
    <Tabs value="name1" class="demo-tabs-style1" :animated="animated">
      <TabPane label="新增商品" name="name1">
        <div class="total-data area-border">
          <div class="grey-bg">基本信息</div>
          <div class="total-cnt">
            <Col :lg="20" offset="2">
            <Form ref="baseInfo" :model="baseInfo" :rules="baseInfoRule" :label-width="80">
              ...
              <FormItem label="展示图" prop="goodsImgs">
                <image-upload :defaultList="defaultList" :target="'goodsPic'" :num="1" :index="'notUse'"
        ...
        <div class="total-data area-border">
          ...
          <div class="total-cnt">
            <Col :lg="20" offset="2">
            <Form ref="baseInfo" :model="baseInfo" :rules="baseInfoRule" :label-width="80">
              <FormItem label="商品轮播图" prop="goodsImgs">
                <image-upload :defaultList="defaultList" :target="'goodsImgs'" :num="8" @getImgList="getImgList"
                              :index="'notUse'" :width="200" :height="200"></image-upload>
              </FormItem>
              <FormItem label="商品详情" prop="goodsDesForm">
        ...
        <Button type="primary" style="margin: 30px 0" @click="newGoods">提交信息</Button>
      </TabPane>
    </Tabs>
    </Col>
  </Row>
  ...
  export default {
    ...
    methods: {
      ...
      newGoods(){
        ...
        this.$ajax.post("/server/addGoods", {
