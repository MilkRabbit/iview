...
<template>
  <Form :label-width="60">
    ...
    <FormItem label="广告内容">
      <vue-editor id="editor3"
                  useCustomImageHandler
                  @imageAdded="handleImageAdded" v-model="bannerInfo3">
      </vue-editor>
    </FormItem>
    <FormItem>
    ...
    methods: {
      ...
      fetchData(){
        this.$ajax.get("/student/page").then(function (res) {
          ...
          this.bannerImg=arr[2].bannerImg
          this.bannerInfo3=arr[2].bannerInfo
          this.banner = [{
            name:this.bannerImg,
            url:this.bannerImg,
          }];
